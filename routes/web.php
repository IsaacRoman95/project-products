...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/subgroups/create', [SubgroupController::class, 'create'])->name('subgroups.create');
    Route::post('/subgroups', [SubgroupController::class, 'store'])->name('subgroups.store');
    Route::get('/subgroups/{subgroup}', [SubgroupController::class, 'show'])->name('subgroups.show');
    Route::get('/subgroups/{subgroup}/edit', [SubgroupController::class, 'edit'])->name('subgroups.edit');
