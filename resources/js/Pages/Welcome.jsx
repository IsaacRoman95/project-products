            ...
            <div className="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div className="text-center mt-6">
                    <h1 className="text-3xl font-semibold text-gray-900">
                        Bienvenido a mi proyecto de Laravel con React
                    </h1>
                    <p className="py-2 font-semibold text-lg">
                        Aqui podrás crear un producto, asignarle un grupo y
                        subgrupo. Asi mismo puedes registrar una nueva venta.
                    </p>
                    <p className="py-1 mb-3 text-base">
                        Inicia Sesión o registrate desde la parte superior derecha para acceder a la app.
                    </p>
                    <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
                        Laravel version {laravelVersion} - PHP version{" "}
                        {phpVersion}
                    </p>
                </div>
            </div>
